...
pub contract NFTMarketplace {
  ...
  pub struct SaleItem {
    ...
    pub let nftRef: &Nu10NFT.NFT
    
    init(_price: UFix64, _nftRef: &Nu10NFT.NFT) {
      self.price = _price
      self.nftRef = _nftRef
    }
  }
  ...
  pub resource interface SaleCollectionPublic {
    ...
    pub fun purchase(id: UInt64, recipientCollection: &Nu10NFT.Collection{NonFungibleToken.CollectionPublic}, payment: @FlowToken.Vault)
  }
  ...
  pub resource SaleCollection: SaleCollectionPublic {
    ...
    pub let MyNFTCollection: Capability<&Nu10NFT.Collection>
    ...
    init(_MyNFTCollection: Capability<&Nu10NFT.Collection>, _FlowTokenVault: Capability<&FlowToken.Vault{FungibleToken.Receiver}>) {
      self.forSale = {}
  ...
  pub fun createSaleCollection(MyNFTCollection: Capability<&Nu10NFT.Collection>, FlowTokenVault: Capability<&FlowToken.Vault{FungibleToken.Receiver}>): @SaleCollection {
